...
RUN git clone --recursive --depth=1 https://github.com/khs1994-docker/libdocker.git /root/khs1994-docker/libdocker \
    && cd /root/khs1994-docker/libdocker \
    && composer install -q \
    && composer update -q \
    && vendor/bin/phpunit
...
COPY --from=0 /root/khs1994-docker/libdocker /root/khs1994-docker/libdocker

RUN cd /root/khs1994-docker/libdocker \
